...
const allTopics: Topic[] = [
  { name: 'Greetings', slugName: japaneseVocabTopicSlugNames.phrases.subTopics.greetings, hasLoginLock: false },
  { name: 'Common Phrases', slugName: japaneseVocabTopicSlugNames.phrases.subTopics.commonPhrases, hasLoginLock: true },
  { name: 'Essential Phrases', slugName: japaneseVocabTopicSlugNames.phrases.subTopics.essentialPhrases, hasLoginLock: true },
];
