      ...
      <div className="page-container">
        <div className="central-container">
          ...
          <div style={{ paddingTop:'20px' }}>
            ...
            <div>
              2. <a href="/japanese/writing-systems?s=hirdak-T0TFT"> 25 hiragana with dakuten and han-dakuten</a>
            </div>
            <div>
              3. <a href="/japanese/writing-systems?s=hiryoon-T0TFT">36 Hiragana Yōon combinations</a>.
            </div>
          </div>
          <div style={{ paddingTop:'20px' }}>
          ...
          <div style={{ paddingTop:'20px' }}>
            <b>Phase 6:</b> learn <a href="/japanese/writing-systems?s=kanji_grade1-T0TFT">first grade kanji</a>.
          </div>
