  ...
  return (
    <>
      <div className="japanese-container">
        ...
        <div style={{ paddingLeft: '20px', paddingTop:'10px' }}>
          <a href="/japanese/vocabulary?s=kanji_grade1-T0TFT">Kanji</a> - a writing system with more than 50,000 characters. The Japanese government has designated 2,136 characters as 'Jōyō kanji' ('daily use kanji').
