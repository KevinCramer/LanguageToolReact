...
const spanishTopics: any[] = [
  ...
  {name:'nouns', contents: ['In english a noun is a person, place, or thing. This is the same for Spanish. The only difference is that Spanish nouns also have a gender, i.e masculine or feminine. So whenever you learn a noun in Spanish it helps to learn what the gender of that noun is. Moreover Many Spanish words have a specific ending that tells you that the word is a noun.',
  ...
  {name:'adjectives', contents: ['An adjective describes a noun, i.e it describes a person, place, or thing. In Spanish the adjective comes before the noun, and the adjective is modified depending on the gender and plurality of the noun it describes. Here are some examples:','\0', 'Alto hombre = tall man (masculine singular)', 'Alta mujer = tall woman (feminine singular)','Altos niños =  tall children (masculine plural)', 'Atlas niñas = tall girls (feminine plural)' ]},
  {name:'verbs', contents: ['Verbs describe an action or state of being, and every sentence has a verb. Verbs have a neutral state called the infinitive. However most sentences do not use the infinitive form of a verb. Instead they use a conjugated form of the verb. Which indicates whether the action or state of being is in the past, present, or future, as well as who is doing the state of being. Their are AR, ER, IR verbs as well as irregular verbs in Spanish.' ]},
