...
const japaneseAudioTranscriptions: AudioTranscriptionWithThreeAlphabet[] = [
  {
    name:'Aiko’s Book Sanctuary', slugName: 'aiko’s-book-sanctuary', contents: [
      { 
        ...
        foreignText: ['Aiko-san wa hon o yomu koto ga daisuki de, jimoto no toshokan de kokoro no yasuragi to tanoshisa o mitsuketeimasu. Maishuu doyoubi no asa, kanojo wa tsugi no bouken ya kyoumi-bukai manabi o sagashite, nanjikan mo tana o arukimawari masu. Aiko-san ni totte toshokan wa tada no dokusho basho de wa naku, isogashii nichijou kara no shizuka na touhi basho desu. Shuu ni yotte, rekishi shousetsu ni bottou suru koto mo areba, shishuu ya shinrigaku no hon o yomu koto mo arimasu.','あいこさんはほんをよむことがだいすきで、じもとのとしょかんでこころのやすらぎとたのしさをみつけています。まいしゅうどようびのあさ、かのじょはつぎのぼうけんやきょうみぶかいまなびをさがして、なんじかんもたなをあるきまわります。あいこさんにとってとしょかんはただのどくしょばしょではなく、いそがしいにちじょうからのしずかなとうひばしょです。しゅうによって、れきししょうせつにぼっとうすることもあれば、ししゅうやしんりがくのほんをよむこともあります。', '愛子さんは本を読むことが大好きで、地元の図書館で心の安らぎと楽しさを見つけています。毎週土曜日の朝、彼女は次の冒険や興味深い学びを探して、何時間も棚を歩き回ります。愛子さんにとって図書館はただの読書場所ではなく、忙しい日常からの静かな逃避場所です。週によって、歴史小説に没頭することもあれば、詩集や心理学の本を読むこともあります。'],
      ...
      { 
        ...
        foreignText: ['Toshokan no ochitsuita fun’iki wa shuchuuryoku o takamete kure, monogatari ni fukaku hairikomu koto ga dekimasu. Aiko-san wa ookina mado no soba ni suwaru no ga suki de, soko kara sashikomu youkou ga heya o atataku terashi, rirakkusu shita dokusho jikan o sugoseru masu. Kanojo wa okiniiri no bunshou ya atarashii aidea o kakitomeru tame ni, nooto o motte kuru koto mo arimasu.','としょかんの落ち着いたふんいきはしゅうちゅうりょくをたかめてくれ、ものがたりにふかくはいりこむことができます。あいこさんはおおきなまどのそばにすわるのがすきで、そこからさしこむようこうがへやをあたたかくてらし、リラックスしたどくしょじかんをすごせます。かのじょはおきにいりのぶんしょうやあたらしいアイデアをかきとめるために、ノートをもってくることもあります。','図書館の落ち着いた雰囲気は集中力を高めてくれ、物語に深く入り込むことができます。愛子さんは大きな窓のそばに座るのが好きで、そこから差し込む陽光が部屋を温かく照らし、リラックスした読書時間を過ごせます。彼女はお気に入りの文章や新しいアイデアを書き留めるために、ノートを持ってくることもあります。'],
      ...
      { 
        ...
        foreignText: ['Toshokan de kanojo ga toku ni suki na no wa, soko de kanjiru komyuniti no fun’iki desu. Shishosan to hanashi o shite atarashii hon o oshiete morattari, tokidoki hoka no dokusho zuki to kaiwa o tanoshindari shimasu. Aiko-san ni totte, toshokan wa manabi to tsunagari no basho de ari, seichou deki, onajiku hon ga suki na hitobito to deairu tokubetsu na basho na no desu.','としょかんでかのじょがとくにすきなのは、そこでかんじるコミュニティのふんいきです。ししょさんとはなしをしてあたらしいほんをおしえてもらったり、ときどきほかのどくしょずきと会話をたのしんだりします。あいこさんにとって、としょかんはまなびとつながりのばしょであり、せいちょうでき、おなじくほんがすきなひとびととであえるとくべつなばしょなのです。','図書館で彼女が特に好きなのは、そこで感じるコミュニティの雰囲気です。司書さんと話をして新しい本を教えてもらったり、時々ほかの読書好きと会話を楽しんだりします。愛子さんにとって、図書館は学びとつながりの場所であり、成長でき、同じく本が好きな人々と出会える特別な場所なのです。'],
...
export const 
  languages: Language[] = 
        [
          ...
          { languageName: 'Japanese', audioTranscriptions: (japaneseAudioTranscriptions), numForeignAlphabets: 3 },
        ]
