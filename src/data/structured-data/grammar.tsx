...
const japaneseTopics: Topic[] = [
  ...
  {
    name: 'Adjectives', slugName: 'adjectives', contents: ['Adjectives come in two forms. Regular adjectives called a i-adjectives and irregular adjectives called na-adjectives.']
  },
