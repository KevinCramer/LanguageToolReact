...
const japaneseTopics: TopicWithThreeAlphabets[] = [
  ...
  { name:'Katakana alphabet', slugName: 'kat', hasOrdering:true, isLocked: true, isAlphabet: true, words: [
    ...
    { englishWord: 'o', foreignWord: ['オ','オ','オ'], foreignAudio: '', order: 4 },
    { englishWord: 'ka', foreignWord: ['カ','カ','カ'], foreignAudio: '', order: 5 },
    { englishWord: 'ki', foreignWord: ['キ','キ','キ'], foreignAudio: '', order: 6 },
    { englishWord: 'ku', foreignWord: ['ク','ク','ク'], foreignAudio: '', order: 7 },
    { englishWord: 'ke', foreignWord: ['ケ','ケ','ケ'], foreignAudio: '', order: 8 },
    { englishWord: 'ko', foreignWord: ['コ','コ','コ'], foreignAudio: '', order: 9 },
    { englishWord: 'sa', foreignWord: ['サ','サ','サ'], foreignAudio: '', order: 10 },
    { englishWord: 'shi', foreignWord: ['シ','シ','シ'], foreignAudio: '', order: 11 },
    { englishWord: 'su', foreignWord: ['ス','ス','ス'], foreignAudio: '', order: 12 },
    { englishWord: 'se', foreignWord: ['セ','セ','セ'], foreignAudio: '', order: 13 },
    { englishWord: 'so', foreignWord: ['ソ','ソ','ソ'], foreignAudio: '', order: 14 },
    { englishWord: 'ta', foreignWord: ['タ','タ','タ'], foreignAudio: '', order: 15 },
    { englishWord: 'chi', foreignWord: ['チ','チ','チ'], foreignAudio: '', order: 16 },
    { englishWord: 'tsu', foreignWord: ['ツ','ツ','ツ'], foreignAudio: '', order: 17 },
    { englishWord: 'te', foreignWord: ['テ','テ','テ'], foreignAudio: '', order: 18 },
    { englishWord: 'to', foreignWord: ['ト','ト','ト'], foreignAudio: '', order: 19 },
    { englishWord: 'na', foreignWord: ['ナ','ナ','ナ'], foreignAudio: '', order: 20 },
    { englishWord: 'ni', foreignWord: ['ニ','ニ','ニ'], foreignAudio: '', order: 21 },
    { englishWord: 'nu', foreignWord: ['ヌ','ヌ','ヌ'], foreignAudio: '', order: 22 },
    { englishWord: 'ne', foreignWord: ['ネ','ネ','ネ'], foreignAudio: '', order: 23 },
    { englishWord: 'no', foreignWord: ['ノ','ノ','ノ'], foreignAudio: '', order: 24 },
    { englishWord: 'ha', foreignWord: ['ハ','ハ','ハ'], foreignAudio: '', order: 25 },
    { englishWord: 'hi', foreignWord: ['ヒ','ヒ','ヒ'], foreignAudio: '', order: 26 },
    { englishWord: 'fu', foreignWord: ['フ','フ','フ'], foreignAudio: '', order: 27 },
    { englishWord: 'he', foreignWord: ['ヘ','ヘ','ヘ'], foreignAudio: '', order: 28 },
    { englishWord: 'ho', foreignWord: ['ホ','ホ','ホ'], foreignAudio: '', order: 29 },
    { englishWord: 'ma', foreignWord: ['マ','マ','マ'], foreignAudio: '', order: 30 },
    { englishWord: 'mi', foreignWord: ['ミ','ミ','ミ'], foreignAudio: '', order: 31 },
    { englishWord: 'mu', foreignWord: ['ム','ム','ム'], foreignAudio: '', order: 32 },
    { englishWord: 'me', foreignWord: ['メ','メ','メ'], foreignAudio: '', order: 33 },
    { englishWord: 'mo', foreignWord: ['モ','モ','モ'], foreignAudio: '', order: 34 },
    { englishWord: 'ya', foreignWord: ['ヤ','ヤ','ヤ'], foreignAudio: '', order: 35 },
    { englishWord: 'yu', foreignWord: ['ユ','ユ','ユ'], foreignAudio: '', order: 36 },
    { englishWord: 'yo', foreignWord: ['ヨ','ヨ','ヨ'], foreignAudio: '', order: 37 },
    { englishWord: 'ra', foreignWord: ['ラ','ラ','ラ'], foreignAudio: '', order: 38 },
    { englishWord: 'ri', foreignWord: ['リ','リ','リ'], foreignAudio: '', order: 39 },
    { englishWord: 'ru', foreignWord: ['ル','ル','ル'], foreignAudio: '', order: 40 },
    { englishWord: 're', foreignWord: ['レ','レ','レ'], foreignAudio: '', order: 41 },
    { englishWord: 'ro', foreignWord: ['ロ','ロ','ロ'], foreignAudio: '', order: 42 },
    { englishWord: 'wa', foreignWord: ['ワ','ワ','ワ'], foreignAudio: '', order: 43 },
    { englishWord: 'wo', foreignWord: ['ヲ','ヲ','ヲ'], foreignAudio: '', order: 44 },
