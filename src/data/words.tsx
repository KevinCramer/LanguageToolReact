...
const dutchTopics: Topic1[] = [
  ...
  {name:"Family", hasOrdering:false, words: [
    ...
    { englishWord: "cousin (m)", foreignWord: ["neef"], foreignAudio: ""},
    { englishWord: "cousin (f)", foreignWord: ["nicht"], foreignAudio: ""},
...
const arabicTopics: Topic2[] = [
  ...
  {name:"Pronouns", hasOrdering:true, words: [
    { englishWord: "I", foreignWord: ["ana A"], foreignAudio: ""},
    { englishWord: "You m/f", foreignWord: ["anta/anti te/te - in"], foreignAudio: ""},
    { englishWord: "He", foreignWord: ["huwa"], foreignAudio: ""},
    { englishWord: "She", foreignWord: ["hiya"], foreignAudio: ""},
    { englishWord: "We", foreignWord: ["nahnou  N-"], foreignAudio: ""},
    { englishWord: "You(p)", foreignWord: ["antum/ antunna"], foreignAudio: ""},
    { englishWord: "They", foreignWord: ["hum"], foreignAudio: ""},
  ]},
