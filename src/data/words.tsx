...
import spanishAudioAwake from '../data/audio_vocab/spanish/adjectives/awake.mp3';
import spanishAudioBad from '../data/audio_vocab/spanish/adjectives/bad.mp3';
import spanishAudioBig from '../data/audio_vocab/spanish/adjectives/big.mp3';
import spanishAudioBoring from '../data/audio_vocab/spanish/adjectives/boring.mp3';
import spanishAudioCalm from '../data/audio_vocab/spanish/adjectives/calm.mp3';
import spanishAudioCheap from '../data/audio_vocab/spanish/adjectives/cheap.mp3';
import spanishAudioClean from '../data/audio_vocab/spanish/adjectives/clean.mp3';
import spanishAudioClosed from '../data/audio_vocab/spanish/adjectives/closed.mp3';
import spanishAudioCold from '../data/audio_vocab/spanish/adjectives/cold.mp3';
import spanishAudioComplicated from '../data/audio_vocab/spanish/adjectives/complicated.mp3';
import spanishAudioCrazy from '../data/audio_vocab/spanish/adjectives/crazy.mp3';
import spanishAudioDelicious from '../data/audio_vocab/spanish/adjectives/delicious.mp3';
import spanishAudioDirty from '../data/audio_vocab/spanish/adjectives/dirty.mp3';
import spanishAudioDisgusting from '../data/audio_vocab/spanish/adjectives/disgusting.mp3';
import spanishAudioDry from '../data/audio_vocab/spanish/adjectives/dry.mp3';
import spanishAudioEmpty from '../data/audio_vocab/spanish/adjectives/empty.mp3';
import spanishAudioExpensive from '../data/audio_vocab/spanish/adjectives/expensive.mp3';
import spanishAudioFair from '../data/audio_vocab/spanish/adjectives/fair.mp3';
import spanishAudioFast from '../data/audio_vocab/spanish/adjectives/fast.mp3';
import spanishAudioFat from '../data/audio_vocab/spanish/adjectives/fat.mp3';
import spanishAudioFull from '../data/audio_vocab/spanish/adjectives/full.mp3';
import spanishAudioFun from '../data/audio_vocab/spanish/adjectives/fun.mp3';
import spanishAudioGood from '../data/audio_vocab/spanish/adjectives/good.mp3';
import spanishAudioHappy from '../data/audio_vocab/spanish/adjectives/happy.mp3';
import spanishAudioHealthy from '../data/audio_vocab/spanish/adjectives/healthy.mp3';
import spanishAudioHot from '../data/audio_vocab/spanish/adjectives/hot.mp3';
import spanishAudioIntelligent from '../data/audio_vocab/spanish/adjectives/intelligent.mp3';
import spanishAudioNew from '../data/audio_vocab/spanish/adjectives/new.mp3';
import spanishAudioOld from '../data/audio_vocab/spanish/adjectives/old.mp3';
import spanishAudioOpen from '../data/audio_vocab/spanish/adjectives/open.mp3';
import spanishAudioPoor from '../data/audio_vocab/spanish/adjectives/poor.mp3';
import spanishAudioPretty from '../data/audio_vocab/spanish/adjectives/pretty.mp3';
import spanishAudioRich from '../data/audio_vocab/spanish/adjectives/rich.mp3';
import spanishAudioSad from '../data/audio_vocab/spanish/adjectives/sad.mp3';
import spanishAudioSalty from '../data/audio_vocab/spanish/adjectives/savory-salty.mp3';
import spanishAudioShort from '../data/audio_vocab/spanish/adjectives/short.mp3';
import spanishAudioSick from '../data/audio_vocab/spanish/adjectives/sick.mp3';
import spanishAudioSimple from '../data/audio_vocab/spanish/adjectives/simple.mp3';
import spanishAudioSlow from '../data/audio_vocab/spanish/adjectives/slow.mp3';
import spanishAudioSmall from '../data/audio_vocab/spanish/adjectives/small.mp3';
import spanishAudioStrong from '../data/audio_vocab/spanish/adjectives/strong.mp3';
import spanishAudioStupid from '../data/audio_vocab/spanish/adjectives/stupid.mp3';
import spanishAudioSweet from '../data/audio_vocab/spanish/adjectives/sweet.mp3';
import spanishAudioTall from '../data/audio_vocab/spanish/adjectives/tall.mp3';
import spanishAudioThin from '../data/audio_vocab/spanish/adjectives/thin.mp3';
import spanishAudioTired from '../data/audio_vocab/spanish/adjectives/tired.mp3';
import spanishAudioUgly from '../data/audio_vocab/spanish/adjectives/ugly.mp3';
import spanishAudioUnfair from '../data/audio_vocab/spanish/adjectives/unfair.mp3';
import spanishAudioWeak from '../data/audio_vocab/spanish/adjectives/weak.mp3';
import spanishAudioWet from '../data/audio_vocab/spanish/adjectives/wet.mp3';

import spanishAudioOne from '../data/audio_vocab/spanish/numbers/one.mp3';
import spanishAudioTwo from '../data/audio_vocab/spanish/numbers/two.mp3';
import spanishAudioThree from '../data/audio_vocab/spanish/numbers/three.mp3';
import spanishAudioFour from '../data/audio_vocab/spanish/numbers/four.mp3';
import spanishAudioFive from '../data/audio_vocab/spanish/numbers/five.mp3';
import spanishAudioSix from '../data/audio_vocab/spanish/numbers/six.mp3';
import spanishAudioSeven from '../data/audio_vocab/spanish/numbers/seven.mp3';
import spanishAudioEight from '../data/audio_vocab/spanish/numbers/eight.mp3';
import spanishAudioNine from '../data/audio_vocab/spanish/numbers/nine.mp3';
import spanishAudioTen from '../data/audio_vocab/spanish/numbers/ten.mp3';

import spanishAudioArm from '../data/audio_vocab/spanish/body/arm.mp3'
import spanishAudioChest from '../data/audio_vocab/spanish/body/chest.mp3'
import spanishAudioEye from '../data/audio_vocab/spanish/body/eye.mp3'
import spanishAudioFace from '../data/audio_vocab/spanish/body/face.mp3'
import spanishAudioFinger from '../data/audio_vocab/spanish/body/finger.mp3'
import spanishAudioFoot from '../data/audio_vocab/spanish/body/foot.mp3'
import spanishAudioHair from '../data/audio_vocab/spanish/body/hair.mp3'
import spanishAudioHand from '../data/audio_vocab/spanish/body/hand.mp3'
import spanishAudioHead from '../data/audio_vocab/spanish/body/head.mp3'
import spanishAudioKnee from '../data/audio_vocab/spanish/body/knee.mp3'
import spanishAudioLeg from '../data/audio_vocab/spanish/body/leg.mp3'
import spanishAudioMouth from '../data/audio_vocab/spanish/body/mouth.mp3'
import spanishAudioNeck from '../data/audio_vocab/spanish/body/neck.mp3'
import spanishAudioNose from '../data/audio_vocab/spanish/body/nose.mp3'

import spanishAudioBathRoom from '../data/audio_vocab/spanish/home/bathroom.mp3'
import spanishAudioBedRoom from '../data/audio_vocab/spanish/home/bedroom.mp3'
import spanishAudioDiningRoom from '../data/audio_vocab/spanish/home/dining-room.mp3'
import spanishAudioGarage from '../data/audio_vocab/spanish/home/garage.mp3'
import spanishAudioGarden from '../data/audio_vocab/spanish/home/garden.mp3'
import spanishAudioKitchen from '../data/audio_vocab/spanish/home/kitchen.mp3'
import spanishAudioLivingRoom from '../data/audio_vocab/spanish/home/living-room.mp3'
import spanishAudioRoom from '../data/audio_vocab/spanish/home/room.mp3'
import spanishAudioWindow from '../data/audio_vocab/spanish/home/window.mp3'

import spanishAudioAirport from '../data/audio_vocab/spanish/locations/airport.mp3'
import spanishAudioBakery from '../data/audio_vocab/spanish/locations/bakery.mp3'
import spanishAudioBank from '../data/audio_vocab/spanish/locations/bank.mp3'
import spanishAudioBridge from '../data/audio_vocab/spanish/locations/bridge.mp3'
import spanishAudioCity from '../data/audio_vocab/spanish/locations/city.mp3'
import spanishAudioFactory from '../data/audio_vocab/spanish/locations/factory.mp3'
import spanishAudioFarm from '../data/audio_vocab/spanish/locations/farm.mp3'
import spanishAudioGym from '../data/audio_vocab/spanish/locations/gym.mp3'
import spanishAudioHospital from '../data/audio_vocab/spanish/locations/hospital.mp3'
import spanishAudioLibrary from '../data/audio_vocab/spanish/locations/library.mp3'
import spanishAudioMuseum from '../data/audio_vocab/spanish/locations/museum.mp3'
import spanishAudioOffice from '../data/audio_vocab/spanish/locations/office.mp3'
import spanishAudioPark from '../data/audio_vocab/spanish/locations/park.mp3'
import spanishAudioRestaurant from '../data/audio_vocab/spanish/locations/restaurant.mp3'
import spanishAudioSchool from '../data/audio_vocab/spanish/locations/school.mp3'
import spanishAudioStreet from '../data/audio_vocab/spanish/locations/street.mp3'
import spanishAudioSwimmingPool from '../data/audio_vocab/spanish/locations/swimming-pool.mp3'
import spanishAudioUniversity from '../data/audio_vocab/spanish/locations/university.mp3'

import spanishAudioI from '../data/audio_vocab/spanish/pronouns/I.mp3'
import spanishAudioYou from '../data/audio_vocab/spanish/pronouns/you.mp3'
import spanishAudioHe from '../data/audio_vocab/spanish/pronouns/he.mp3'
import spanishAudioShe from '../data/audio_vocab/spanish/pronouns/she.mp3'
import spanishAudioWe from '../data/audio_vocab/spanish/pronouns/we.mp3'
import spanishAudioYouPlural from '../data/audio_vocab/spanish/pronouns/you(plural).mp3'
import spanishAudioTheyMasculine from '../data/audio_vocab/spanish/pronouns/they(masculine).mp3'
import spanishAudioTheyFeminine from '../data/audio_vocab/spanish/pronouns/they(feminine).mp3'

import spanishAudioWhy from '../data/audio_vocab/spanish/question-words/why.mp3'
import spanishAudioWhere from '../data/audio_vocab/spanish/question-words/where.mp3'
import spanishAudioWhen from '../data/audio_vocab/spanish/question-words/when.mp3'
import spanishAudioWhat from '../data/audio_vocab/spanish/question-words/what.mp3'
import spanishAudioHow from '../data/audio_vocab/spanish/question-words/how.mp3'

import spanishAudioToBe1 from '../data/audio_vocab/spanish/verbs/to-be-1.mp3'
import spanishAudioToBe2 from '../data/audio_vocab/spanish/verbs/to-be-2.mp3'
import spanishAudioToBeAbleTo from '../data/audio_vocab/spanish/verbs/to-be-able-to.mp3'
import spanishAudioToCall from '../data/audio_vocab/spanish/verbs/to-call.mp3'
import spanishAudioToDo from '../data/audio_vocab/spanish/verbs/to-do.mp3'
import spanishAudioToDrink from '../data/audio_vocab/spanish/verbs/to-drink.mp3'
import spanishAudioToEat from '../data/audio_vocab/spanish/verbs/to-eat.mp3'
import spanishAudioToGive from '../data/audio_vocab/spanish/verbs/to-give.mp3'
import spanishAudioToGo from '../data/audio_vocab/spanish/verbs/to-go.mp3'
import spanishAudioToHave1 from '../data/audio_vocab/spanish/verbs/to-have-1.mp3'
import spanishAudioToHave2 from '../data/audio_vocab/spanish/verbs/to-have-2.mp3'
import spanishAudioToKnow from '../data/audio_vocab/spanish/verbs/to-know.mp3'
import spanishAudioToLive from '../data/audio_vocab/spanish/verbs/to-live.mp3'
import spanishAudioToNeed from '../data/audio_vocab/spanish/verbs/to-need.mp3'
import spanishAudioToPut from '../data/audio_vocab/spanish/verbs/to-put.mp3'
import spanishAudioToSay from '../data/audio_vocab/spanish/verbs/to-say.mp3'
import spanishAudioToSee from '../data/audio_vocab/spanish/verbs/to-see.mp3'
import spanishAudioToSpeak from '../data/audio_vocab/spanish/verbs/to-speak.mp3'
import spanishAudioToStudy from '../data/audio_vocab/spanish/verbs/to-study.mp3'
import spanishAudioToWant from '../data/audio_vocab/spanish/verbs/to-want.mp3'

import spanishAudioBread from '../data/audio_vocab/spanish/food/bread.mp3'
import spanishAudioButter from '../data/audio_vocab/spanish/food/butter.mp3'
import spanishAudioCheese from '../data/audio_vocab/spanish/food/cheese.mp3'
import spanishAudioChicken from '../data/audio_vocab/spanish/food/chicken.mp3'
import spanishAudioEgg from '../data/audio_vocab/spanish/food/egg.mp3'
import spanishAudioFish from '../data/audio_vocab/spanish/food/fish.mp3'
import spanishAudioGarlic from '../data/audio_vocab/spanish/food/garlic.mp3'
import spanishAudioMeat from '../data/audio_vocab/spanish/food/meat.mp3'
import spanishAudioPotato from '../data/audio_vocab/spanish/food/potato.mp3'
import spanishAudioStrawberry from '../data/audio_vocab/spanish/food/strawberry.mp3'

import spanishAudioHat from '../data/audio_vocab/spanish/clothes/hat.mp3'
import spanishAudioJacket from '../data/audio_vocab/spanish/clothes/jacket.mp3'
import spanishAudioScarf from '../data/audio_vocab/spanish/clothes/scarf.mp3'
import spanishAudioShoes from '../data/audio_vocab/spanish/clothes/shoes.mp3'
import spanishAudioSkirt from '../data/audio_vocab/spanish/clothes/skirt.mp3'
import spanishAudioSweater from '../data/audio_vocab/spanish/clothes/sweater.mp3'
import spanishAudioTie from '../data/audio_vocab/spanish/clothes/tie.mp3'
import spanishAudioTrousers from '../data/audio_vocab/spanish/clothes/trousers.mp3'
import spanishAudioUnderwear from '../data/audio_vocab/spanish/clothes/underwear.mp3'

import spanishAudioBlue from '../data/audio_vocab/spanish/colours/blue.mp3'
import spanishAudioBrown from '../data/audio_vocab/spanish/colours/brown.mp3'
import spanishAudioGreen from '../data/audio_vocab/spanish/colours/green.mp3'
import spanishAudioGrey from '../data/audio_vocab/spanish/colours/grey.mp3'
import spanishAudioOrange from '../data/audio_vocab/spanish/colours/orange.mp3'
import spanishAudioPink from '../data/audio_vocab/spanish/colours/pink.mp3'
import spanishAudioPurple from '../data/audio_vocab/spanish/colours/purple.mp3'
import spanishAudioRed from '../data/audio_vocab/spanish/colours/red.mp3'
import spanishAudioWhite from '../data/audio_vocab/spanish/colours/white.mp3'
import spanishAudioBlack from '../data/audio_vocab/spanish/colours/black.mp3'

import spanishAudioAnd from '../data/audio_vocab/spanish/conjunctions/and.mp3'
import spanishAudioBut from '../data/audio_vocab/spanish/conjunctions/but.mp3'
import spanishAudioEvenThough from '../data/audio_vocab/spanish/conjunctions/even-though.mp3'
import spanishAudioFor from '../data/audio_vocab/spanish/conjunctions/for.mp3'
import spanishAudioMoreover from '../data/audio_vocab/spanish/conjunctions/moreover.mp3'
import spanishAudioNevertheless from '../data/audio_vocab/spanish/conjunctions/nevertheless.mp3'
import spanishAudioNor from '../data/audio_vocab/spanish/conjunctions/nor.mp3'
import spanishAudioNotYet from '../data/audio_vocab/spanish/conjunctions/not-yet.mp3'
import spanishAudioOr from '../data/audio_vocab/spanish/conjunctions/or.mp3'
import spanishAudioSo from '../data/audio_vocab/spanish/conjunctions/so.mp3'
import spanishAudioYet from '../data/audio_vocab/spanish/conjunctions/yet.mp3'

import germanAudioOne from '../data/audio_vocab/german/numbers/one.mp3';
import germanAudioTwo from '../data/audio_vocab/german/numbers/two.mp3';
import germanAudioThree from '../data/audio_vocab/german/numbers/three.mp3';
import germanAudioFour from '../data/audio_vocab/german/numbers/four.mp3';
import germanAudioFive from '../data/audio_vocab/german/numbers/five.mp3';
import germanAudioSix from '../data/audio_vocab/german/numbers/six.mp3';
import germanAudioSeven from '../data/audio_vocab/german/numbers/seven.mp3';
import germanAudioEight from '../data/audio_vocab/german/numbers/eight.mp3';
import germanAudioNine from '../data/audio_vocab/german/numbers/nine.mp3';
import germanAudioTen from '../data/audio_vocab/german/numbers/ten.mp3';

import germanAudioHat from '../data/audio_vocab/german/clothes/hat.mp3'
import germanAudioJacket from '../data/audio_vocab/german/clothes/jacket.mp3'
import germanAudioScarf from '../data/audio_vocab/german/clothes/scarf.mp3'
import germanAudioShoes from '../data/audio_vocab/german/clothes/shoes.mp3'
import germanAudioSocks from '../data/audio_vocab/german/clothes/socks.mp3'
import germanAudioSkirt from '../data/audio_vocab/german/clothes/skirt.mp3'
import germanAudioSweater from '../data/audio_vocab/german/clothes/sweater.mp3'
import germanAudioTie from '../data/audio_vocab/german/clothes/tie.mp3'
import germanAudioTrousers from '../data/audio_vocab/german/clothes/trousers.mp3'
import germanAudioUnderwear from '../data/audio_vocab/german/clothes/underwear.mp3'

import germanAudioBlue from '../data/audio_vocab/german/colours/blue.mp3'
import germanAudioBrown from '../data/audio_vocab/german/colours/brown.mp3'
import germanAudioGreen from '../data/audio_vocab/german/colours/green.mp3'
import germanAudioGrey from '../data/audio_vocab/german/colours/grey.mp3'
import germanAudioOrange from '../data/audio_vocab/german/colours/orange.mp3'
import germanAudioPink from '../data/audio_vocab/german/colours/pink.mp3'
import germanAudioPurple from '../data/audio_vocab/german/colours/purple.mp3'
import germanAudioRed from '../data/audio_vocab/german/colours/red.mp3'
import germanAudioWhite from '../data/audio_vocab/german/colours/white.mp3'
import germanAudioBlack from '../data/audio_vocab/german/colours/black.mp3'
