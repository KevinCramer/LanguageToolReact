...
const spanishTopics: Topic1[] = [
  ...
  {name:'Body', hasOrdering:false, words: [
    ...
    { englishWord: 'head', foreignWord: ['cabeza'], foreignAudio: ''},
    { englishWord: 'hair', foreignWord: ['pelo'], foreignAudio: ''},
    { englishWord: 'neck', foreignWord: ['cuello'], foreignAudio: ''},
    { englishWord: 'chest', foreignWord: ['pecho'], foreignAudio: ''},
    { englishWord: 'arm', foreignWord: ['brazo'], foreignAudio: ''},
    { englishWord: 'finger', foreignWord: ['dedo'], foreignAudio: ''},
    { englishWord: 'foot', foreignWord: ['pie'], foreignAudio: ''},
    { englishWord: 'eye', foreignWord: ['ojo'], foreignAudio: ''},
    { englishWord: 'face', foreignWord: ['cara'], foreignAudio: ''},
    { englishWord: 'nose', foreignWord: ['nariz'], foreignAudio: ''},
    { englishWord: 'mouth', foreignWord: ['boca'], foreignAudio: ''},
    { englishWord: 'leg', foreignWord: ['pierna'], foreignAudio: ''},
    { englishWord: 'knee', foreignWord: ['rodilla'], foreignAudio: ''},

  ]},
  {name:'Buildings/ Locations', hasOrdering:false, words: [
    { englishWord: 'airport', foreignWord: ['aeropuerto'], foreignAudio: ''},
    { englishWord: 'bakery', foreignWord: ['panadería'], foreignAudio: ''},
    { englishWord: 'bank', foreignWord: ['banco'], foreignAudio: ''},
    { englishWord: 'bridge', foreignWord: ['puente'], foreignAudio: ''},
    { englishWord: 'city', foreignWord: ['ciudad'], foreignAudio: ''},
    { englishWord: 'court', foreignWord: ['cuzgado'], foreignAudio: ''},
    { englishWord: 'factory', foreignWord: ['fábrica'], foreignAudio: ''},
    { englishWord: 'farm', foreignWord: ['granja'], foreignAudio: ''},
    { englishWord: 'gym', foreignWord: ['gimnasio'], foreignAudio: ''},
    { englishWord: 'hospital', foreignWord: ['hospital'], foreignAudio: ''},
    { englishWord: 'library', foreignWord: ['biblioteca'], foreignAudio: ''},
    { englishWord: 'museum', foreignWord: ['museo'], foreignAudio: ''},
    { englishWord: 'office', foreignWord: ['oficina'], foreignAudio: ''},
    { englishWord: 'park', foreignWord: ['parque'], foreignAudio: ''},
    { englishWord: 'swimming pool', foreignWord: ['piscina'], foreignAudio: ''},
    { englishWord: 'restaurant', foreignWord: ['restaurante'], foreignAudio: ''},
    { englishWord: 'school', foreignWord: ['escuela'], foreignAudio: ''},
    { englishWord: 'street', foreignWord: ['calle'], foreignAudio: ''},
    { englishWord: 'university', foreignWord: ['universidad'], foreignAudio: ''},
    { englishWord: 'village', foreignWord: ['pueblo'], foreignAudio: ''},

  ]},
  {name:'Home', hasOrdering:false, words: [
    { englishWord: 'window', foreignWord: ['ventana'], foreignAudio: ''},
    { englishWord: 'stairs', foreignWord: ['escalera'], foreignAudio: ''},
    { englishWord: 'bedroom', foreignWord: ['dormitorio'], foreignAudio: ''},
    { englishWord: 'kitchen', foreignWord: ['cocina'], foreignAudio: ''},
    { englishWord: 'dining room', foreignWord: ['comedor'], foreignAudio: ''},
    { englishWord: 'bathroom', foreignWord: ['el cuarto de baño'], foreignAudio: ''},
    { englishWord: 'garage', foreignWord: ['garaje'], foreignAudio: ''},
    { englishWord: 'room', foreignWord: ['ventana'], foreignAudio: ''},
    { englishWord: 'window', foreignWord: ['habitación'], foreignAudio: ''},
    { englishWord: 'garden', foreignWord: ['jardín'], foreignAudio: ''},
    { englishWord: 'living room', foreignWord: ['salón'], foreignAudio: ''},
  ]},
  {name:'Question words', hasOrdering:false, words: [
